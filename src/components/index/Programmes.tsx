        ...
        <div className="flex flex-col justify-center">
          <div className="flex flex-wrap justify-center">
            <div className="flex flex-row justify-center">
              <Link href="/programmes/sci_math">
                <div className="flex flex-col cursor-pointer hover:bg-gray-100 mt-2 mx-1 justify-center items-center text-xs md:text-lg bg-white shadow-md rounded-xl md:rounded-3xl w-32 h-20 md:w-60 md:h-36">
                  <Scimath className="w-9 md:w-18 h-9 md:h-18" />
                  <h1 className="mt-2">วิทย์-คณิต</h1>
                </div>
              </Link>
              <Link href="/programmes/lang_math">
                <div className="flex flex-col cursor-pointer hover:bg-gray-100 mt-2 mx-1 justify-center items-center text-xs md:text-lg bg-white shadow-md rounded-xl md:rounded-3xl w-32 h-20 md:w-60 md:h-36">
