        ...
        <div className="flex flex-col justify-center">
          <div className="flex flex-wrap justify-center">
            <div className="flex flex-row justify-center">
              <div
                className="flex flex-col mt-2 mx-1 justify-center items-center text-xs md:text-lg bg-white shadow-md rounded-xl md:rounded-3xl w-32 h-20 md:w-60 md:h-36">
