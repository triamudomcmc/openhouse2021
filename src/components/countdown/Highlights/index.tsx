      ...
      <div className="flex flex-wrap justify-center mt-8 md:mt-12 font-display">
        <div className="flex flex-col items-center mt-0 md:mt-16 ml-4 md:ml-8 mr-4 inline-block">
          ...
          <div className="flex flex-col h-full text-right items-center justify-center">
            <div
              className="hidden md:block text-base font-normal text-gray-500 text-center md:text-2xl md:leading-normal md:w-80">
              <p>Live แนะนำสายการเรียน</p>
              <p>สัมภาษณ์รุ่นพี่ และคอนเทนต์น่าสนใจอื่น ๆ อีกมากมาย</p>
            </div>
            <div
              className="block md:hidden text-base font-normal text-gray-500 text-center md:text-2xl md:leading-normal md:w-80">
              <p className="w-64 md:w-auto">Live แนะนำสายการเรียน สัมภาษณ์รุ่นพี่ และคอนเทนต์น่าสนใจอื่น ๆ อีกมากมาย</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center mt-16 mx-4 inline-block">
          ...
          <div className="flex flex-col h-full text-right md:items-center md:justify-center">
            <div
              className="mt-2 md:mt-6 text-base font-normal text-center text-gray-500 w-44 md:text-center md:text-2xl md:leading-normal md:w-64">
